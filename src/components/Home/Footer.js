...
export default function Footer() {
  ...
  return (
    <>
      <div className="bg-blue-900 md:pl-10 text-white grid md:grid-cols-4 sm:grid-cols-2 gap-4">
      ...
      <footer className='bg-blue-900'>
        ...
        <Link to="https://www.facebook.com" className="mr-3">
        ...
        <Link to="https://www.instagram.com" className="mr-3">
        ...
        <Link to="https://twitter.com" className="mr-3">
          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="42" viewBox="0 0 44 42" fill="none">
